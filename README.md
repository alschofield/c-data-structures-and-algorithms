...
src/algorithms/searching/{linear-search,binary-search}           complete
...
src/algorithms/graph-traversal/breadth-first-search             complete
...
counting, radix sort, linear/binary search, and breadth-first search have

...
static void test_invalid_and_trivial_inputs(void) {
    ...
    assert(!selection_sort(NULL, 1U, compare_ints));
    assert(selection_sort(NULL, 0U, compare_ints));
    assert(selection_sort(single, 1U, compare_ints));
...
static void test_sorts_shuffled_values(void) {
    ...
    assert(selection_sort(items, 10U, compare_ints));
...
static void test_large_shuffled_input(void) {
    ...
    assert(selection_sort(items, ITEM_COUNT, compare_ints));

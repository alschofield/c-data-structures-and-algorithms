...
static void test_invalid_and_trivial_inputs(void) {
    ...
    assert(!merge_sort(NULL, 1U, compare_ints));
    assert(merge_sort(NULL, 0U, compare_ints));
    assert(merge_sort(single, 1U, compare_ints));
...
static void test_sorts_shuffled_values(void) {
    ...
    assert(merge_sort(items, 10U, compare_ints));
...
static void test_sorted_reverse_and_equal_inputs(void) {
    ...
    assert(merge_sort(items, 6U, compare_ints));
    ...
    assert(merge_sort(items, 4U, compare_ints));
...
static void test_equal_keys_keep_original_order(void) {
    ...
    assert(merge_sort(items, 6U, compare_record_keys));
...
static void test_large_shuffled_input(void) {
    ...
    assert(merge_sort(items, ITEM_COUNT, compare_ints));

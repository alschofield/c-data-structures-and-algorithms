...
static void test_invalid_and_trivial_inputs(void) {
    ...
    assert(!quick_sort(NULL, 1U, compare_ints));
    assert(quick_sort(NULL, 0U, compare_ints));
    assert(quick_sort(single, 1U, compare_ints));
...
static void test_sorts_shuffled_values(void) {
    ...
    assert(quick_sort(items, 10U, compare_ints));
...
static void test_sorted_reverse_and_equal_inputs(void) {
    ...
    assert(quick_sort(items, 6U, compare_ints));
    ...
    assert(quick_sort(items, 4U, compare_ints));
...
static void test_large_shuffled_input(void) {
    ...
    assert(quick_sort(items, ITEM_COUNT, compare_ints));
